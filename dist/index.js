...
var AvatarComponent = /** @class */ (function (_super) {
    ...
    AvatarComponent.prototype.render = function () {
        var _a = this.props, avatarStyle = _a.avatarStyle, style = _a.style, avatarBackground = _a.avatarBackground;
        return React.createElement(avatar_1.default, { avatarStyle: avatarStyle, style: style, avatarBackground: avatarBackground });
    };
